// diwali\backend\controllers\videoController.js (FINAL & CORRECTED CODE)
...
exports.generateVideo = async (req, res) => {
    ...
    // FIX 1: Dynamic Font Path for Local (Windows) and Production (Linux)
    ...
    try {
        await new Promise((resolve, reject) => {
            ffmpeg(videoPath)
                ...
                // FIX 2: Performance options for Render's Free Plan
                .outputOptions([
                    '-preset ultrafast',
                    '-crf 28',
                    '-c:a copy'
